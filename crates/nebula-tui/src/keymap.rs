...
impl Action {
    /// `SelectTabN` → the 0-based tab index it targets.
...
pub const ACTIONS: &[ActionSpec] = &[
    ...
    ActionSpec {
        ...
        id: "select_tab_1",
        label: "Go to tab 1",
        hint: "Select the worktree's 1st session tab (stays attached when input is locked)",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+1", "1"],
    },
    ActionSpec {
        ...
        id: "select_tab_2",
        label: "Go to tab 2",
        hint: "Select the worktree's 2nd session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+2", "2"],
    },
    ActionSpec {
        ...
        id: "select_tab_3",
        label: "Go to tab 3",
        hint: "Select the worktree's 3rd session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+3", "3"],
    },
    ActionSpec {
        ...
        id: "select_tab_4",
        label: "Go to tab 4",
        hint: "Select the worktree's 4th session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+4", "4"],
    },
    ActionSpec {
        ...
        id: "select_tab_5",
        label: "Go to tab 5",
        hint: "Select the worktree's 5th session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+5", "5"],
    },
    ActionSpec {
        ...
        id: "select_tab_6",
        label: "Go to tab 6",
        hint: "Select the worktree's 6th session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+6", "6"],
    },
    ActionSpec {
        ...
        id: "select_tab_7",
        label: "Go to tab 7",
        hint: "Select the worktree's 7th session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+7", "7"],
    },
    ActionSpec {
        ...
        id: "select_tab_8",
        label: "Go to tab 8",
        hint: "Select the worktree's 8th session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+8", "8"],
    },
    ActionSpec {
        ...
        id: "select_tab_9",
        label: "Go to tab 9",
        hint: "Select the worktree's 9th session tab",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+9", "9"],
    },
    ...
    ActionSpec {
        ...
        hint: "Fuzzy-search agent sessions only; Enter attaches (also a command-palette row)",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["shift+s"],
    },
    ActionSpec {
        ...
        hint: "Fuzzy launcher over every command; Enter chains into the existing flows (⌘K in the ng Ghostty overlay)",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+k", "shift+p"],
    },
    ActionSpec {
    ...
    ActionSpec {
        ...
        hint: "New project / worktree / agent, depending on which section has focus",
        group: "PROJECTS & WORKTREES",
        scope: Scope::Global,
        defaults: &["n"],
    },
    ...
    ActionSpec {
        ...
        id: "new_agent",
        label: "New agent",
        hint: "Create in the focused worktree section, or open the new-session picker elsewhere (⌘n also works inside a locked session)",
        group: "SESSIONS",
        scope: Scope::Global,
        defaults: &["cmd+n", "ctrl+n"],
    },
    ActionSpec {
        action: Action::NewSessionPicker,
        id: "new_session_picker",
        label: "New session…",
        hint: "Open the agent/terminal picker for the selected worktree (or the project's main checkout)",
        group: "SESSIONS",
        scope: Scope::Global,
        defaults: &["t"],
    },
    ...
    ActionSpec {
        ...
        hint: "Split the pane: pick what runs on the right (Claude/Codex/Cursor/Pi or a shell, the current kind pre-hovered). The split belongs to the current tab — other tabs show none, coming back restores it; ⌘d again closes the pane (the session lives on as a tab)",
        group: "SESSIONS",
        scope: Scope::Global,
        defaults: &["cmd+d", "|"],
    },
    ActionSpec {
        action: Action::FocusOtherPane,
        id: "focus_other_pane",
        label: "Switch split pane",
        hint: "Move the input lock to the ⌘D split's other pane (⌘o works inside a locked session)",
        group: "SESSIONS",
        scope: Scope::Global,
        defaults: &["cmd+o", "shift+o"],
    },
    ActionSpec {
