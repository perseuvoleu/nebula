...
pub const ACTIONS: &[ActionSpec] = &[
    ...
    ActionSpec {
        action: Action::FocusProjectsPanel,
        id: "focus_projects_panel",
        label: "Go to Projects",
        hint: "Jump straight to the Projects panel",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+1", "1"],
    },
    ActionSpec {
        action: Action::FocusOrchestratorsPanel,
        id: "focus_orchestrators_panel",
        label: "Go to Orchestrators",
        hint: "Jump straight to the Orchestrators section",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+2", "2"],
    },
    ActionSpec {
        action: Action::FocusWorktreesPanel,
        id: "focus_worktrees_panel",
        label: "Go to Worktrees",
        hint: "Jump straight to the Worktrees section",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+3", "3"],
    },
    ActionSpec {
        action: Action::FocusSessionsPanel,
        id: "focus_sessions_panel",
        label: "Go to Sessions",
        hint: "Jump straight to the session tab bar",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+4", "4"],
    },
    ActionSpec {
        action: Action::FocusTerminalPanel,
        id: "focus_terminal_panel",
        label: "Go to Terminal",
        hint: "Jump into the terminal pane (locks input when a session is attached)",
        group: "NAVIGATE",
        scope: Scope::Global,
        defaults: &["cmd+5", "5"],
    },
